    ...
    public class RichString
    {
        ...
        class ParagraphInfo
        {
            ...
            public SKPoint TextBlockPaintPosition(RichString owner)
            {
                ...
                if (!owner.MaxWidth.HasValue)
                {
                    ...
                    {
                        case TextKit.TextAlignment.Center:
                            xPos += (owner.MeasuredWidth - TextBlock.MeasuredWidth) / 2;
                            break;

                        case TextKit.TextAlignment.Right:
            ...
            public void Layout(ref LayoutContext ctx)
            {
                ...
                // Set the TextBlock
                TextBlock.Alignment = TextAlignment ?? ctx.textAlignment ?? TextKit.TextAlignment.Auto;
                TextBlock.BaseDirection = BaseDirection ?? ctx.baseDirection ?? TextKit.TextDirection.Auto;
        ...
        class NormalItem : Item
        {
            ...
            public override void Build(BuildContext ctx)
            {
                ...
                ctx.StyleManager.FontVariant(TextKit.FontVariant.Normal);
            }
        }
